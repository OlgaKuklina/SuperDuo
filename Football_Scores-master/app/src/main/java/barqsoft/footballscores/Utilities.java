...
public class Utilities
{
    ...
    {
        if (league_num == Leagues.CHAMPIONS_LEAGUE) {
            if (match_day <= 6) {
                return res.getString(R.string.group_stages, match_day);
            ...
            return res.getString(R.string.match_day, match_day);
        }
    }
    ...
    public static String getScores(Resources res, int home_goals,int awaygoals)
    {
        ...
        {
            return res.getString(R.string.scores, home_goals, awaygoals);
        }
    }
